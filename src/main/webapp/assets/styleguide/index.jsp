...
<h1 class="sg-page-header">Getting Started</h1>

<div class="sg-section">
    <h2 class="sg-section-header" id="Introduction">Introduction</h1>
    <p>In this section we will outline our FE development approach.</p>
</div>

<div class="sg-section">
    <h2 class="sg-section-header" id="Methodology">Methodology</h1>
...
<div class="sg-section">
    <h2 class="sg-section-header" id="CSS Framework">CSS Framework</h1>
...
<div class="sg-section">
    <h2 class="sg-section-header" id="JS Framework">JS Framework</h1>
...
<div class="sg-section">
    <h2 class="sg-section-header" id="Code Style and Convention">Code Style and Convention</h1>
    ...
    <h3 class="sg-section-subhead">All</h3>
    ...
    <h3 class="sg-section-subhead">CSS</h3>
    <ul class="sg-simple-list">
    ...
    <h3 class="sg-section-subhead">JS</h3>
    <ul class="sg-simple-list">
